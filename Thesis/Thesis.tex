...
\input{Structure/4_Inclusion}
\newpage

\pagenumbering{Roman}

\input{Structure/5_Abstract}
\newpage

\pagestyle{plain}

\input{Structure/6_Tabe-of-Contents}
\newpage

\cleardoublepage
\input{Structure/7_Acronyms}
